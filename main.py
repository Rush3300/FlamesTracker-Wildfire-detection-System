...
# About Page
    ...
    """)
    st.image("https://whnt.com/wp-content/uploads/sites/20/2016/08/1927l9.gif?w=1280", use_container_width=True)

# Contact Page
elif selected == "Contact":
    st.markdown('<div class="fire-title">Contact Us</div>', unsafe_allow_html=True)
    st.write("""
        - **Email**: landagerushika1@gmail.com  
        - **Phone**: +91 234 567 890  
        - **Address**: 123 Wildfire Prevention Lane, Earth
    """)
    st.image("https://img.freepik.com/premium-vector/software-developer-vector-illustration-communication-technology-cyber-security_1249867-5464.jpg?semt=ais_hybrid", use_container_width=True)

# Footer section
st.markdown(
    """
    <div class="footer">
        Built with ❤️ by Rushika. Stay safe and vigilant!
    </div>
    """,
    unsafe_allow_html=True,
)
